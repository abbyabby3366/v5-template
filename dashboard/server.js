...
function processCentralQueue() {
  ...
  const splitResult = resolveSplitBetTargets(betEntry.recommendedBetAmount, activeModules, betConfig);
  ...
  // Dispatch via splitBet module (handles both split and single fallback)
  dispatchBet(splitResult, betEntry, {
    activeModules,
    betLog,
    MAX_BET_LOG,
    dbCollection,
    onRetry: processCentralQueue,
  });
